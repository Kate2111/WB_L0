import {addFavorite, deleteItem} from './actionItem';

const cartItem = (data) => {
    class MenuCard {
        constructor(imgLink, subtitle, title, color, size, parentSelector) {
    ...
    data.forEach(elem => {
        new MenuCard(elem.img_link, elem.subtitle, elem.title, elem.color, elem.size, '.absence .basket__list').render();
    });
